"""Project Challenge: ETL Pipeline Simualtion
    ...
    E) Complete ETL pipeline by storing cleaned data back into dataframe, save to csv file
    """
# A) MYSQL to connect to data warehouse for ETL Pipeline Example
"""
...
sales = [random.choice(range(10000,100000)) for i in range(N)]
...
#E) Complete ETL pipeline by storing cleaned data back into dataframe, save to csv file to Load to MYSQL
